...
class QueryByMicrochipNumberCatTest extends CatServiceTest {
    @Autowired
    ...
    void validateInjection() {
        ...
        assertTrue(applicationContext.containsBean(CatSpringBeanServiceNames.QUERY_BY_MICROSERVICE_NUMBER));
    }
}
